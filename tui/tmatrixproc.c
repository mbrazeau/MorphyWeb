...
int tui_test_matrix_processing(mfl_handle_s *mfl_handle)
{
    char wagners[] = "1-3 6";
    char costmat[] = "8-10";
    char symbols[] = "21034"; // Note: not in order
    ...
    //mfl_handle->gap_method = MFL_GAP_MISSING_DATA;
    ...
    mfl_partition_set_t* ptset = mfl_create_data_partitions_set(internmatrix, (const mfl_handle_s*)mfl_handle);
